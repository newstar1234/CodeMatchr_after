...
import { AUTHENTICATION_PATH, BOARD_DETAIL_PATH, BOARD_LIST_PATH, BOARD_NUMBER_PATH_VARIABLE, BOARD_UPDATE_PATH, COMPARE_PATH, MAIN_PATH, ROOM_DETAIL_PATH, ROOM_NUMBER_PATH_VARIABLE, ROOM_PATH, ROOM_SEARCH_PATH, ROOM_SEARCH_PATH_VARIABLE, SEARCH_PATH, SEARCH_WORD_PATH_VARIABLE, USER_PAGE_PATH_VARIABLE, USER_PATH, WRITE_PATH } from './constants';
